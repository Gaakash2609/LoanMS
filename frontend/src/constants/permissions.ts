...
export interface RolePermissionFlags {
  ...
  canTabDocuments: boolean; canTabLenderDetails: boolean; canTabTimeline: boolean; canTabTasks: boolean; canTabObligations: boolean; canTabOffers: boolean; canTabReports: boolean
...
export const DEFAULT_ROLES: Record<RoleKey, RoleRecord> = {
  admin: {
    ...
    canTabDocuments: true, canTabLenderDetails: true, canTabTimeline: true, canTabTasks: true, canTabObligations: true, canTabOffers: true, canTabReports: true,
  ...
  login_team: {
    ...
    restrictions: [
      ...
      'Cannot decide a deviation they raised, or credit-approve offer terms they created (maker-checker)',
  ...
  team_leader: {
    ...
    canRejectApp: true, canHoldApp: true, canDisburse: false, canDeviation: true,
    canViewOverview: true,
    canViewPersonal: true, canMaskPersonal: false,
    canViewAddress: true,
    canViewEmployment: true,
    ...
    canNavReports: true, canNavTickets: true,
    desc: 'Deputy Sales Manager — supervises one or more Login Teams, raises deviations, ensures SLA compliance, and manages escalations. Bridges front-line operations with management.',
  ...
  sales_executive: {
    ...
    canEditDetails: true,
    canTabOverview: true, canTabPersonal: true, canTabAddress: true, canTabEmployment: true, canTabReferences: true,
    canTabDocuments: true, canTabLenderDetails: false, canTabTimeline: true, canTabTasks: false, canTabObligations: true, canTabOffers: true, canTabReports: false,
  ...
  accounts: {
    ...
    canTabDocuments: false, canTabLenderDetails: false, canTabTimeline: false, canTabTasks: false, canTabObligations: true, canTabOffers: true, canTabReports: false,
  ...
  partner: {
    ...
    canTabDocuments: false, canTabLenderDetails: false, canTabTimeline: true, canTabTasks: false, canTabObligations: true, canTabOffers: true, canTabReports: false,
    canNavOverview: true, canNavApplications: true, canNavRegisterNew: true, canNavCalculator: true, canNavTasks: false, canNavPayout: true,
    canNavBanks: false, canNavIncred: false, canNavDSA: false, canNavPartner: false,
    canNavTeamOverview: false, canNavSalesTeams: false, canNavLoginTeams: false, canNavLocations: false, canNavUsers: false,
    canNavReports: false, canNavTickets: true,
  ...
  manager: {
    ...
    responsibilities: [
      ...
      'Raise deviations, change status, reject and hold (deviation / credit approval, sanction and disbursement are view-only)',
    ...
    desc: 'Business Development Manager — oversees multiple teams, raises deviations and manages pipeline (deviation / credit approval, sanction and disbursement are view-only). Cannot create applications or upload documents.',
  },
  operation_manager: {
    ...
    desc: 'Credit Evaluation Manager — senior ops lead who owns the Login Team workflow. Full pipeline access including deviation approval, credit approval, sanction and disbursement.',
  },
  dsa_user: {
  ...
  product_team: {
    ...
    canEditDetails: true,
    canTabOverview: false, canTabPersonal: false, canTabAddress: false, canTabEmployment: false, canTabReferences: false,
    canTabDocuments: false, canTabLenderDetails: false, canTabTimeline: false, canTabTasks: false, canTabObligations: false, canTabOffers: false, canTabReports: false,
...
export const MASTER_PERM_GROUPS: { group: string; perms: [keyof RolePermissionFlags, string][] }[] = [
  ...
  },
  {
    group: 'App Detail Tabs', perms: [
      ...
      ['canTabTasks', 'Tab: Tasks'], ['canTabObligations', 'Tab: Obligations'], ['canTabOffers', 'Tab: Offers'],
