...
export const STATUS_COLORS: Record<string, CSSProperties> = {
  ...
  // Lender offers / final selection / credit approval — legacy 'offer' stage
  // (PIPELINE_STAGE_META colour #0a589a, the brand blue).
  Offer:       { background: 'rgba(10, 88, 154, .10)',   color: '#0a589a' },
}
